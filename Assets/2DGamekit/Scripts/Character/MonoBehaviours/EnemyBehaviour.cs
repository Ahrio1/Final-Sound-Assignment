...
namespace Gamekit2D
{
    ...
    public class EnemyBehaviour : MonoBehaviour
    {
        ...
        public void ScanForPlayer()
        {
            ...
            {
                audioManager.CombatState(false);
                //Debug.Log("NoControl");
                return;
            }
            ...
            if (!isAggro)
            {
                AudioManager.Instance.aggroEnemyCount++;
                isAggro = true;
            }
        ...
        public void CheckMeleeAttack()
        {
            ...
            if((m_Target.transform.position - transform.position).sqrMagnitude < (meleeRange * meleeRange))
            {
                ...
                audioManager.PlayEnemyMelee(gameObject);
            }
        }
        ...
        public void Die(Damager damager, Damageable damageable)
        {
            ...
            audioManager.PlayEnemyDeath(gameObject);
        ...
        public void PlayFootStep(int walkType)
        {
            audioManager.PlayEnemyFootstep(gameObject, walkType);
        }
